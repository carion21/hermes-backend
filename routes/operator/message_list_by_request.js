...
const { control_headers_for_operator, control_service_data, get_message_data } = require('../../config/global_functions');
const router = express.Router();

const moment = getMoment();
const service = "operator"

const SERVICE_TYPE = "operator_message_list_by_request"
const hms = getModel()
